    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "data_cleaning",
                    wagtail.core.fields.StreamField([], blank=True, null=True),
                ),
                (
                    "preprocessing",
                                ...
                                wagtail.core.blocks.StructBlock(
                                    [
                                        (
                                            ...
                                            wagtail.core.blocks.IntegerBlock(
                                                default=5,
                                                help_text="The number of evolutionary generations",
                                                min_value=0,
                                            ),
                                        ),
                                        (
                                            ...
                                            wagtail.core.blocks.IntegerBlock(
                                                default=20,
                                                help_text="The number of algorithms in each generation",
                                                min_value=0,
                                            ),
                                        ),
                                        (
                                        ...
                                        (
                                            "verbosity",
                                            wagtail.core.blocks.IntegerBlock(default=2),
                                        ),
                                    ]
                                ),
                            )
            ...
            fields=[
                ...
                (
                    ...
                    models.FloatField(
                        ...
                        validators=[wagtail_easyai.models.project.validate_proportion],
                    ),
                ),
                (
