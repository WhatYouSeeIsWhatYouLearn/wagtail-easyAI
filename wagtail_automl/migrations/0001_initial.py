# Generated by Django 3.1.8 on 2021-04-12 17:15

from django.db import migrations, models
import django.db.models.deletion
import wagtail.core.blocks
import wagtail.core.fields
import wagtail_automl.models.project
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=255)),
                ('train_proportion', models.FloatField(default=0.8, help_text='Proportion of training data that should be used for training (complement will be used for testing)', validators=[wagtail_automl.models.project.validate_proportion])),
                ...
                ('pipeline_object', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mlproject_pipeline', to='wagtail_automl.mlpipeline')),
